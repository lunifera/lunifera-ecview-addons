 ...
 * <ul>
 *   <li>{@link org.lunifera.ecview.semantic.uimodel.impl.UiTargetBindingEndpointImpl#getEmbeddable <em>Embeddable</em>}</li>
 *   <li>{@link org.lunifera.ecview.semantic.uimodel.impl.UiTargetBindingEndpointImpl#getEndpoint <em>Endpoint</em>}</li>
 *   <li>{@link org.lunifera.ecview.semantic.uimodel.impl.UiTargetBindingEndpointImpl#getPath <em>Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UiTargetBindingEndpointImpl extends MinimalEObjectImpl.Container implements UiTargetBindingEndpoint {
	...
	protected EClass eStaticClass() {
		return UimodelPackage.Literals.UI_TARGET_BINDING_ENDPOINT;
	}
		...
		if (embeddable != null && embeddable.eIsProxy()) {
			...
			if (embeddable != oldEmbeddable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UimodelPackage.UI_TARGET_BINDING_ENDPOINT__EMBEDDABLE, oldEmbeddable, embeddable));
			}
		}
		return embeddable;
	}
	...
	public void setEmbeddable(YBindable newEmbeddable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelPackage.UI_TARGET_BINDING_ENDPOINT__EMBEDDABLE, oldEmbeddable, embeddable));
	}
	...
	public UxEndpointDef getEndpoint() {
		if (endpoint != null && endpoint.eIsProxy()) {
			...
			if (endpoint != oldEndpoint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UimodelPackage.UI_TARGET_BINDING_ENDPOINT__ENDPOINT, oldEndpoint, endpoint));
			}
		}
		return endpoint;
	}
	...
	public void setEndpoint(UxEndpointDef newEndpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelPackage.UI_TARGET_BINDING_ENDPOINT__ENDPOINT, oldEndpoint, endpoint));
	}
	...
	public NotificationChain basicSetPath(UiPathSegment newPath, NotificationChain msgs) {
		...
		path = newPath;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UimodelPackage.UI_TARGET_BINDING_ENDPOINT__PATH, oldPath, newPath);
	...
	public void setPath(UiPathSegment newPath) {
		if (newPath != path) {
			...
			if (path != null)
				msgs = ((InternalEObject)path).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UimodelPackage.UI_TARGET_BINDING_ENDPOINT__PATH, null, msgs);
			if (newPath != null)
				msgs = ((InternalEObject)newPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UimodelPackage.UI_TARGET_BINDING_ENDPOINT__PATH, null, msgs);
			msgs = basicSetPath(newPath, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UimodelPackage.UI_TARGET_BINDING_ENDPOINT__PATH, newPath, newPath));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UimodelPackage.UI_TARGET_BINDING_ENDPOINT__PATH:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UimodelPackage.UI_TARGET_BINDING_ENDPOINT__EMBEDDABLE:
				if (resolve) return getEmbeddable();
				return basicGetEmbeddable();
			case UimodelPackage.UI_TARGET_BINDING_ENDPOINT__ENDPOINT:
