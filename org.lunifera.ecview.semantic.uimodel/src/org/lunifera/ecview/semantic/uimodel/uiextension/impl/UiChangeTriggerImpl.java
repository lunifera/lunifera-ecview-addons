 ...
 * <ul>
 *   <li>{@link org.lunifera.ecview.semantic.uimodel.uiextension.impl.UiChangeTriggerImpl#getEndpoint <em>Endpoint</em>}</li>
 *   <li>{@link org.lunifera.ecview.semantic.uimodel.uiextension.impl.UiChangeTriggerImpl#getEndpointAlias <em>Endpoint Alias</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UiChangeTriggerImpl extends MinimalEObjectImpl.Container implements UiChangeTrigger {
	...
	protected EClass eStaticClass() {
		return UiextensionPackage.Literals.UI_CHANGE_TRIGGER;
	}
	...
	public NotificationChain basicSetEndpoint(UiBindingEndpointDef newEndpoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UiextensionPackage.UI_CHANGE_TRIGGER__ENDPOINT, oldEndpoint, newEndpoint);
	...
	public void setEndpoint(UiBindingEndpointDef newEndpoint) {
		if (newEndpoint != endpoint) {
			...
			if (endpoint != null)
				msgs = ((InternalEObject)endpoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UiextensionPackage.UI_CHANGE_TRIGGER__ENDPOINT, null, msgs);
			if (newEndpoint != null)
				msgs = ((InternalEObject)newEndpoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UiextensionPackage.UI_CHANGE_TRIGGER__ENDPOINT, null, msgs);
			msgs = basicSetEndpoint(newEndpoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionPackage.UI_CHANGE_TRIGGER__ENDPOINT, newEndpoint, newEndpoint));
	}
	...
	public UiBindingEndpointAlias getEndpointAlias() {
		if (endpointAlias != null && endpointAlias.eIsProxy()) {
			...
			if (endpointAlias != oldEndpointAlias) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UiextensionPackage.UI_CHANGE_TRIGGER__ENDPOINT_ALIAS, oldEndpointAlias, endpointAlias));
			}
		}
	...
	public void setEndpointAlias(UiBindingEndpointAlias newEndpointAlias) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionPackage.UI_CHANGE_TRIGGER__ENDPOINT_ALIAS, oldEndpointAlias, endpointAlias));
	}
