 ...
 * <ul>
 *   <li>{@link org.lunifera.ecview.dsl.uIGrammar.impl.UiSourceBindingEndpointImpl#getEmbeddable <em>Embeddable</em>}</li>
 *   <li>{@link org.lunifera.ecview.dsl.uIGrammar.impl.UiSourceBindingEndpointImpl#getEndpoint <em>Endpoint</em>}</li>
 *   <li>{@link org.lunifera.ecview.dsl.uIGrammar.impl.UiSourceBindingEndpointImpl#getPath <em>Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UiSourceBindingEndpointImpl extends MinimalEObjectImpl.Container implements UiSourceBindingEndpoint
{
  ...
  {
    return UIGrammarPackage.Literals.UI_SOURCE_BINDING_ENDPOINT;
  }
    ...
    if (embeddable != null && embeddable.eIsProxy())
    {
      ...
      if (embeddable != oldEmbeddable)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__EMBEDDABLE, oldEmbeddable, embeddable));
      }
    }
    return embeddable;
  }
  ...
  public void setEmbeddable(YBindable newEmbeddable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__EMBEDDABLE, oldEmbeddable, embeddable));
  }
  ...
  public UxEndpointDefCommon getEndpoint()
  {
    if (endpoint != null && endpoint.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__ENDPOINT, oldEndpoint, endpoint));
      }
    }
    return endpoint;
  }
  ...
  public void setEndpoint(UxEndpointDefCommon newEndpoint)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__ENDPOINT, oldEndpoint, endpoint));
  }
  ...
  public NotificationChain basicSetPath(UiPathSegment newPath, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__PATH, oldPath, newPath);
  ...
  public void setPath(UiPathSegment newPath)
  {
    if (newPath != path)
    {
      ...
      if (path != null)
        msgs = ((InternalEObject)path).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__PATH, null, msgs);
      if (newPath != null)
        msgs = ((InternalEObject)newPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__PATH, null, msgs);
      msgs = basicSetPath(newPath, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__PATH, newPath, newPath));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__PATH:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__EMBEDDABLE:
        if (resolve) return getEmbeddable();
        return basicGetEmbeddable();
      case UIGrammarPackage.UI_SOURCE_BINDING_ENDPOINT__ENDPOINT:
