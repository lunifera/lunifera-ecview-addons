        ...
        final Procedure1<JvmOperation> _function_4 = new Procedure1<JvmOperation>() {
          public void apply(final JvmOperation it) {
            ...
            StringConcatenationClient _client = new StringConcatenationClient() {
              @Override
              protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
                _builder.append("return org.eclipse.emf.ecp.ecview.common.validation.Status.createStatus(errorCode, getClass(), IStatus.Severity.ERROR, message);");
                _builder.newLine();
              }
            };
            UIGrammarJvmModelInferrer.this._jvmTypesBuilder.setBody(it, _client);
        ...
        final Procedure1<JvmOperation> _function_5 = new Procedure1<JvmOperation>() {
          public void apply(final JvmOperation it) {
            ...
            StringConcatenationClient _client = new StringConcatenationClient() {
              @Override
              protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
                _builder.append("return org.eclipse.emf.ecp.ecview.common.validation.Status.createStatus(errorCode, getClass(), IStatus.Severity.WARNING, message);");
                _builder.newLine();
              }
            };
            UIGrammarJvmModelInferrer.this._jvmTypesBuilder.setBody(it, _client);
