...
/**
 * Manual modifications go to {org.lunifera.ecview.uisemantics.UISemanticsGrammarRuntimeModule}
 */
...
public abstract class AbstractUISemanticsGrammarRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/lunifera/ecview/uisemantics/UISemanticsGrammar.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.lunifera.ecview.uisemantics.UISemanticsGrammar");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("uisemantics");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.lunifera.ecview.uisemantics.services.UISemanticsGrammarGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.lunifera.ecview.uisemantics.serializer.UISemanticsGrammarSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.lunifera.ecview.uisemantics.serializer.UISemanticsGrammarSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.lunifera.ecview.uisemantics.parser.antlr.UISemanticsGrammarParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.lunifera.ecview.uisemantics.parser.antlr.UISemanticsGrammarAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.lunifera.ecview.uisemantics.parser.antlr.internal.InternalUISemanticsGrammarLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.lunifera.ecview.uisemantics.parser.antlr.internal.InternalUISemanticsGrammarLexer> provideInternalUISemanticsGrammarLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.lunifera.ecview.uisemantics.parser.antlr.internal.InternalUISemanticsGrammarLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.lunifera.ecview.uisemantics.parser.antlr.internal.InternalUISemanticsGrammarLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.lunifera.ecview.uisemantics.validation.UISemanticsGrammarValidator> bindUISemanticsGrammarValidator() {
		return org.lunifera.ecview.uisemantics.validation.UISemanticsGrammarValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.lunifera.ecview.uisemantics.formatting.UISemanticsGrammarFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.lunifera.ecview.uisemantics.jvmmodel.UISemanticsGrammarJvmModelInferrer.class;
	}
