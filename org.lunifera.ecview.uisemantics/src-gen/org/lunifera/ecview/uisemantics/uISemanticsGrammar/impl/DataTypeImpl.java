 ...
 * <ul>
 *   <li>{@link org.lunifera.ecview.uisemantics.uISemanticsGrammar.impl.DataTypeImpl#getJvmType <em>Jvm Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataTypeImpl extends MinimalEObjectImpl.Container implements DataType
{
  ...
  {
    return UISemanticsGrammarPackage.Literals.DATA_TYPE;
  }
  ...
  public NotificationChain basicSetJvmType(JvmTypeReference newJvmType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UISemanticsGrammarPackage.DATA_TYPE__JVM_TYPE, oldJvmType, newJvmType);
  ...
  public void setJvmType(JvmTypeReference newJvmType)
  {
    if (newJvmType != jvmType)
    {
      ...
      if (jvmType != null)
        msgs = ((InternalEObject)jvmType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UISemanticsGrammarPackage.DATA_TYPE__JVM_TYPE, null, msgs);
      if (newJvmType != null)
        msgs = ((InternalEObject)newJvmType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UISemanticsGrammarPackage.DATA_TYPE__JVM_TYPE, null, msgs);
      msgs = basicSetJvmType(newJvmType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UISemanticsGrammarPackage.DATA_TYPE__JVM_TYPE, newJvmType, newJvmType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UISemanticsGrammarPackage.DATA_TYPE__JVM_TYPE:
