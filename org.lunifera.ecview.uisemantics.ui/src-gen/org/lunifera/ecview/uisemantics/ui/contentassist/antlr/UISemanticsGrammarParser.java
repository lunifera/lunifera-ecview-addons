...
* generated by Xtext
*/
package org.lunifera.ecview.uisemantics.ui.contentassist.antlr;
...
public class UISemanticsGrammarParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.lunifera.ecview.uisemantics.ui.contentassist.antlr.internal.InternalUISemanticsGrammarParser createParser() {
		org.lunifera.ecview.uisemantics.ui.contentassist.antlr.internal.InternalUISemanticsGrammarParser result = new org.lunifera.ecview.uisemantics.ui.contentassist.antlr.internal.InternalUISemanticsGrammarParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUxVisibilityOptionAccess().getGroup(), "rule__UxVisibilityOption__Group__0");
					...
					put(grammarAccess.getUxAvailableVisibilityOptionsAccess().getOptionsAssignment_1(), "rule__UxAvailableVisibilityOptions__OptionsAssignment_1");
					put(grammarAccess.getUxVisibilityOptionAccess().getNameAssignment_1(), "rule__UxVisibilityOption__NameAssignment_1");
					put(grammarAccess.getUxVisibilityOptionAccess().getJvmTypeAssignment_2(), "rule__UxVisibilityOption__JvmTypeAssignment_2");
