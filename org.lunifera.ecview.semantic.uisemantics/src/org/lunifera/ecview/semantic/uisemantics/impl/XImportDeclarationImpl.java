 ...
 * <em><b>XImport Declaration</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.lunifera.ecview.semantic.uisemantics.impl.XImportDeclarationImpl#getImportedEPackage
 * <em>Imported EPackage</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class XImportDeclarationImpl extends
		org.eclipse.xtext.xtype.impl.XImportDeclarationImpl implements
		XImportDeclaration {
	/**
	 * The cached value of the '{@link #getImportedEPackage()
	 * <em>Imported EPackage</em>}' containment reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 ...
	 * @generated
	 */
	public NotificationChain basicSetImportedEPackage(
			UxEPackageImport newImportedEPackage, NotificationChain msgs) {
		UxEPackageImport oldImportedEPackage = importedEPackage;
		importedEPackage = newImportedEPackage;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					UiSemanticsPackage.XIMPORT_DECLARATION__IMPORTED_EPACKAGE,
					oldImportedEPackage, newImportedEPackage);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setImportedEPackage(UxEPackageImport newImportedEPackage) {
		if (newImportedEPackage != importedEPackage) {
			...
			if (importedEPackage != null)
				msgs = ((InternalEObject) importedEPackage)
						.eInverseRemove(
								this,
			...
			if (newImportedEPackage != null)
				msgs = ((InternalEObject) newImportedEPackage)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- UiSemanticsPackage.XIMPORT_DECLARATION__IMPORTED_EPACKAGE,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					UiSemanticsPackage.XIMPORT_DECLARATION__IMPORTED_EPACKAGE,
					newImportedEPackage, newImportedEPackage));
	}
