		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUiFormLayoutAccess().getGroup_2(), "rule__UiFormLayout__Group_2__0");
					...
					put(grammarAccess.getUiSplitpanelAccess().getGroup_1(), "rule__UiSplitpanel__Group_1__0");
					...
					put(grammarAccess.getUiFormLayoutAccess().getFillVerticalAssignment_2_1_0(), "rule__UiFormLayout__FillVerticalAssignment_2_1_0");
					put(grammarAccess.getUiFormLayoutAccess().getFillHorizontalAssignment_2_1_1(), "rule__UiFormLayout__FillHorizontalAssignment_2_1_1");
					put(grammarAccess.getUiFormLayoutAccess().getI18nInfoAssignment_2_1_2(), "rule__UiFormLayout__I18nInfoAssignment_2_1_2");
					...
					put(grammarAccess.getUiFormLayoutAccess().getProcessorAssignmentAssignment_7(), "rule__UiFormLayout__ProcessorAssignmentAssignment_7");
					...
					put(grammarAccess.getUiMobileHorizontalButtonGroupAccess().getI18nInfoAssignment_2_1(), "rule__UiMobileHorizontalButtonGroup__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiMobileVerticalComponentGroupAccess().getI18nInfoAssignment_2_1(), "rule__UiMobileVerticalComponentGroup__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiTabSheetAccess().getI18nInfoAssignment_2_1(), "rule__UiTabSheet__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiSplitpanelAccess().getI18nInfoAssignment_1_1(), "rule__UiSplitpanel__I18nInfoAssignment_1_1");
					...
					put(grammarAccess.getUiSplitpanelAccess().getProcessorAssignmentAssignment_6(), "rule__UiSplitpanel__ProcessorAssignmentAssignment_6");
					put(grammarAccess.getUiSplitpanelAssigmentAccess().getElementAssignment(), "rule__UiSplitpanelAssigment__ElementAssignment");
					put(grammarAccess.getUiPanelAccess().getI18nInfoAssignment_1_1(), "rule__UiPanel__I18nInfoAssignment_1_1");
					...
					put(grammarAccess.getUiPanelAccess().getProcessorAssignmentAssignment_7(), "rule__UiPanel__ProcessorAssignmentAssignment_7");
					...
					put(grammarAccess.getUiMobileNavigationPageAccess().getI18nInfoAssignment_2_1(), "rule__UiMobileNavigationPage__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiTextAreaAccess().getI18nInfoAssignment_2_1(), "rule__UiTextArea__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiDateFieldAccess().getI18nInfoAssignment_2_1(), "rule__UiDateField__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiBrowserAccess().getI18nInfoAssignment_2_1(), "rule__UiBrowser__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiProgressBarAccess().getI18nInfoAssignment_2_1(), "rule__UiProgressBar__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiImageAccess().getI18nInfoAssignment_2_1(), "rule__UiImage__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiListAccess().getI18nInfoAssignment_2_1(), "rule__UiList__I18nInfoAssignment_2_1");
					put(grammarAccess.getUiListAccess().getNameAssignment_3(), "rule__UiList__NameAssignment_3");
					put(grammarAccess.getUiTableAccess().getI18nInfoAssignment_2_1(), "rule__UiTable__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiTableAccess().getProcessorAssignmentAssignment_4_4(), "rule__UiTable__ProcessorAssignmentAssignment_4_4");
					put(grammarAccess.getUiComboBoxAccess().getI18nInfoAssignment_2_1(), "rule__UiComboBox__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiComboBoxAccess().getItemImagePropertyAssignment_4_1_2_1(), "rule__UiComboBox__ItemImagePropertyAssignment_4_1_2_1");
					...
					put(grammarAccess.getUiComboBoxAccess().getProcessorAssignmentAssignment_4_3(), "rule__UiComboBox__ProcessorAssignmentAssignment_4_3");
					put(grammarAccess.getUiButtonAccess().getI18nInfoAssignment_2_1(), "rule__UiButton__I18nInfoAssignment_2_1");
					put(grammarAccess.getUiButtonAccess().getNameAssignment_3(), "rule__UiButton__NameAssignment_3");
					put(grammarAccess.getUiMobileNavigationButtonAccess().getI18nInfoAssignment_2_1(), "rule__UiMobileNavigationButton__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiMobileSwitchAccess().getI18nInfoAssignment_2_1(), "rule__UiMobileSwitch__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiLabelAccess().getI18nInfoAssignment_2_1(), "rule__UiLabel__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiOptionsGroupAccess().getI18nInfoAssignment_2_1(), "rule__UiOptionsGroup__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiOptionsGroupAccess().getItemImagePropertyAssignment_4_1_3_1(), "rule__UiOptionsGroup__ItemImagePropertyAssignment_4_1_3_1");
					...
					put(grammarAccess.getUiOptionsGroupAccess().getProcessorAssignmentAssignment_4_3(), "rule__UiOptionsGroup__ProcessorAssignmentAssignment_4_3");
					...
					put(grammarAccess.getUiCheckBoxAccess().getI18nInfoAssignment_2_1(), "rule__UiCheckBox__I18nInfoAssignment_2_1");
					...
					put(grammarAccess.getUiFormLayoutAccess().getUnorderedGroup_2_1(), "rule__UiFormLayout__UnorderedGroup_2_1");
