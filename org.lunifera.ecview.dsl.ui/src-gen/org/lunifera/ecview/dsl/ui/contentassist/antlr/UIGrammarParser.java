		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUiSourceBindingEndpointAccess().getGroup(), "rule__UiSourceBindingEndpoint__Group__0");
					put(grammarAccess.getUiTargetBindingEndpointAccess().getGroup(), "rule__UiTargetBindingEndpoint__Group__0");
					...
					put(grammarAccess.getUiViewSetAccess().getNameAssignment_2(), "rule__UiViewSet__NameAssignment_2");
					put(grammarAccess.getUiViewSetAccess().getBeanSlotsAssignment_3_0_2(), "rule__UiViewSet__BeanSlotsAssignment_3_0_2");
					put(grammarAccess.getUiViewSetAccess().getViewsAssignment_3_1(), "rule__UiViewSet__ViewsAssignment_3_1");
					put(grammarAccess.getUiBeanSlotAccess().getNameAssignment_2(), "rule__UiBeanSlot__NameAssignment_2");
					put(grammarAccess.getUiBeanSlotAccess().getJvmTypeAssignment_4(), "rule__UiBeanSlot__JvmTypeAssignment_4");
					put(grammarAccess.getUiIDEViewAccess().getNameAssignment_1(), "rule__UiIDEView__NameAssignment_1");
					put(grammarAccess.getUiIDEViewAccess().getLayoutsAssignment_3(), "rule__UiIDEView__LayoutsAssignment_3");
					put(grammarAccess.getUiIDEViewAccess().getBindingsAssignment_4(), "rule__UiIDEView__BindingsAssignment_4");
					...
					put(grammarAccess.getUiBindingAccess().getSourceAssignment_1(), "rule__UiBinding__SourceAssignment_1");
					...
					put(grammarAccess.getUiBindingAccess().getTargetAssignment_3(), "rule__UiBinding__TargetAssignment_3");
					put(grammarAccess.getUiSourceBindingEndpointAccess().getEmbeddableAssignment_0(), "rule__UiSourceBindingEndpoint__EmbeddableAssignment_0");
					put(grammarAccess.getUiSourceBindingEndpointAccess().getEndpointAssignment_2(), "rule__UiSourceBindingEndpoint__EndpointAssignment_2");
					put(grammarAccess.getUiSourceBindingEndpointAccess().getPathAssignment_3(), "rule__UiSourceBindingEndpoint__PathAssignment_3");
					put(grammarAccess.getUiTargetBindingEndpointAccess().getEmbeddableAssignment_0(), "rule__UiTargetBindingEndpoint__EmbeddableAssignment_0");
					put(grammarAccess.getUiTargetBindingEndpointAccess().getEndpointAssignment_2(), "rule__UiTargetBindingEndpoint__EndpointAssignment_2");
					put(grammarAccess.getUiTargetBindingEndpointAccess().getPathAssignment_3(), "rule__UiTargetBindingEndpoint__PathAssignment_3");
					put(grammarAccess.getUiPathSegmentAccess().getJvmFieldAssignment_2(), "rule__UiPathSegment__JvmFieldAssignment_2");
