		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUiRadioButtonGroupAccess().getGroup(), "rule__UiRadioButtonGroup__Group__0");
					put(grammarAccess.getUiRadioButtonGroupAccess().getGroup_3(), "rule__UiRadioButtonGroup__Group_3__0");
					put(grammarAccess.getUiRadioButtonGroupAccess().getGroup_3_1_0(), "rule__UiRadioButtonGroup__Group_3_1_0__0");
					put(grammarAccess.getUiRadioButtonGroupAccess().getGroup_3_1_1(), "rule__UiRadioButtonGroup__Group_3_1_1__0");
					put(grammarAccess.getUiRadioButtonGroupAccess().getGroup_3_1_2(), "rule__UiRadioButtonGroup__Group_3_1_2__0");
					put(grammarAccess.getUiRadioButtonGroupAccess().getGroup_3_1_3(), "rule__UiRadioButtonGroup__Group_3_1_3__0");
					...
					put(grammarAccess.getUiIDEViewAccess().getBeanSlotsAssignment_4(), "rule__UiIDEView__BeanSlotsAssignment_4");
					...
					put(grammarAccess.getUiMobileViewAccess().getBeanSlotsAssignment_4(), "rule__UiMobileView__BeanSlotsAssignment_4");
					...
					put(grammarAccess.getUiDateFieldAccess().getValidatorsAssignment_3_1(), "rule__UiDateField__ValidatorsAssignment_3_1");
					put(grammarAccess.getUiBrowserAccess().getNameAssignment_2(), "rule__UiBrowser__NameAssignment_2");
					put(grammarAccess.getUiBrowserAccess().getValidatorsAssignment_3_1(), "rule__UiBrowser__ValidatorsAssignment_3_1");
					put(grammarAccess.getUiProgressBarAccess().getNameAssignment_2(), "rule__UiProgressBar__NameAssignment_2");
					put(grammarAccess.getUiProgressBarAccess().getValidatorsAssignment_3_1(), "rule__UiProgressBar__ValidatorsAssignment_3_1");
					...
					put(grammarAccess.getUiTableAccess().getBindingsAssignment_3_3(), "rule__UiTable__BindingsAssignment_3_3");
					...
					put(grammarAccess.getUiComboBoxAccess().getBindingsAssignment_3_2(), "rule__UiComboBox__BindingsAssignment_3_2");
					...
					put(grammarAccess.getUiDecimalFieldAccess().getValidatorsAssignment_4_1(), "rule__UiDecimalField__ValidatorsAssignment_4_1");
					put(grammarAccess.getUiRadioButtonGroupAccess().getNameAssignment_2(), "rule__UiRadioButtonGroup__NameAssignment_2");
					put(grammarAccess.getUiRadioButtonGroupAccess().getJvmTypeAssignment_3_1_0_1(), "rule__UiRadioButtonGroup__JvmTypeAssignment_3_1_0_1");
					put(grammarAccess.getUiRadioButtonGroupAccess().getSelectionTypeAssignment_3_1_1_1(), "rule__UiRadioButtonGroup__SelectionTypeAssignment_3_1_1_1");
					put(grammarAccess.getUiRadioButtonGroupAccess().getItemCaptionPropertyAssignment_3_1_2_1(), "rule__UiRadioButtonGroup__ItemCaptionPropertyAssignment_3_1_2_1");
					put(grammarAccess.getUiRadioButtonGroupAccess().getItemImagePropertyAssignment_3_1_3_1(), "rule__UiRadioButtonGroup__ItemImagePropertyAssignment_3_1_3_1");
					put(grammarAccess.getUiRadioButtonGroupAccess().getBindingsAssignment_3_2(), "rule__UiRadioButtonGroup__BindingsAssignment_3_2");
					...
					put(grammarAccess.getUiNumericFieldAccess().getValidatorsAssignment_4_1(), "rule__UiNumericField__ValidatorsAssignment_4_1");
					...
					put(grammarAccess.getUiRadioButtonGroupAccess().getUnorderedGroup_3_1(), "rule__UiRadioButtonGroup__UnorderedGroup_3_1");
