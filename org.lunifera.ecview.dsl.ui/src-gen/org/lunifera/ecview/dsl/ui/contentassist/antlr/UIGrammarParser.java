		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUiIDEViewAccess().getAlternatives_6(), "rule__UiIDEView__Alternatives_6");
					put(grammarAccess.getUiMobileViewAccess().getAlternatives_4(), "rule__UiMobileView__Alternatives_4");
					put(grammarAccess.getUiMobileViewAccess().getAlternatives_6(), "rule__UiMobileView__Alternatives_6");
					put(grammarAccess.getUiTextFieldAccess().getAlternatives_4_1(), "rule__UiTextField__Alternatives_4_1");
					put(grammarAccess.getUiTextAreaAccess().getAlternatives_3_1(), "rule__UiTextArea__Alternatives_3_1");
					put(grammarAccess.getUiDateFieldAccess().getAlternatives_3_1(), "rule__UiDateField__Alternatives_3_1");
					put(grammarAccess.getUiBrowserAccess().getAlternatives_3_1(), "rule__UiBrowser__Alternatives_3_1");
					put(grammarAccess.getUiProgressBarAccess().getAlternatives_3_1(), "rule__UiProgressBar__Alternatives_3_1");
					put(grammarAccess.getUiTableAccess().getAlternatives_3_3(), "rule__UiTable__Alternatives_3_3");
					put(grammarAccess.getUiComboBoxAccess().getAlternatives_3_2(), "rule__UiComboBox__Alternatives_3_2");
					put(grammarAccess.getUiMobileNavigationButtonAccess().getAlternatives_3(), "rule__UiMobileNavigationButton__Alternatives_3");
					put(grammarAccess.getUiMobileSwitchAccess().getAlternatives_3_2(), "rule__UiMobileSwitch__Alternatives_3_2");
					put(grammarAccess.getUiDecimalFieldAccess().getAlternatives_4_1(), "rule__UiDecimalField__Alternatives_4_1");
					put(grammarAccess.getUiOptionsGroupAccess().getAlternatives_3_2(), "rule__UiOptionsGroup__Alternatives_3_2");
					...
					put(grammarAccess.getUiCheckBoxAccess().getAlternatives_3_1(), "rule__UiCheckBox__Alternatives_3_1");
					put(grammarAccess.getUiValidatorAccess().getAlternatives(), "rule__UiValidator__Alternatives");
					put(grammarAccess.getUiVisibilityProcessorAccess().getAlternatives_6_2(), "rule__UiVisibilityProcessor__Alternatives_6_2");
					...
					put(grammarAccess.getUiMobileViewAccess().getGroup_3(), "rule__UiMobileView__Group_3__0");
					...
					put(grammarAccess.getUiVerticalLayoutAccess().getGroup_2(), "rule__UiVerticalLayout__Group_2__0");
					put(grammarAccess.getUiHorizontalLayoutAccess().getGroup(), "rule__UiHorizontalLayout__Group__0");
					put(grammarAccess.getUiHorizontalLayoutAccess().getGroup_2(), "rule__UiHorizontalLayout__Group_2__0");
					...
					put(grammarAccess.getUiDialogAccess().getGroup_4(), "rule__UiDialog__Group_4__0");
					...
					put(grammarAccess.getUiSearchDialogAccess().getGroup_4(), "rule__UiSearchDialog__Group_4__0");
					...
					put(grammarAccess.getUiDateFieldAccess().getGroup_3(), "rule__UiDateField__Group_3__0");
					put(grammarAccess.getUiBrowserAccess().getGroup(), "rule__UiBrowser__Group__0");
					put(grammarAccess.getUiBrowserAccess().getGroup_3(), "rule__UiBrowser__Group_3__0");
					put(grammarAccess.getUiProgressBarAccess().getGroup(), "rule__UiProgressBar__Group__0");
					put(grammarAccess.getUiProgressBarAccess().getGroup_3(), "rule__UiProgressBar__Group_3__0");
					put(grammarAccess.getUiImageAccess().getGroup(), "rule__UiImage__Group__0");
					put(grammarAccess.getUiImageAccess().getGroup_3(), "rule__UiImage__Group_3__0");
					put(grammarAccess.getUiImageAccess().getGroup_3_1(), "rule__UiImage__Group_3_1__0");
					...
					put(grammarAccess.getUiTableAccess().getGroup_3(), "rule__UiTable__Group_3__0");
					put(grammarAccess.getUiTableAccess().getGroup_3_1_0(), "rule__UiTable__Group_3_1_0__0");
					put(grammarAccess.getUiTableAccess().getGroup_3_1_1(), "rule__UiTable__Group_3_1_1__0");
					put(grammarAccess.getUiTableAccess().getGroup_3_1_2(), "rule__UiTable__Group_3_1_2__0");
					put(grammarAccess.getUiComboBoxAccess().getGroup(), "rule__UiComboBox__Group__0");
					put(grammarAccess.getUiComboBoxAccess().getGroup_3(), "rule__UiComboBox__Group_3__0");
					put(grammarAccess.getUiComboBoxAccess().getGroup_3_1_0(), "rule__UiComboBox__Group_3_1_0__0");
					put(grammarAccess.getUiComboBoxAccess().getGroup_3_1_1(), "rule__UiComboBox__Group_3_1_1__0");
					put(grammarAccess.getUiComboBoxAccess().getGroup_3_1_2(), "rule__UiComboBox__Group_3_1_2__0");
					...
					put(grammarAccess.getUiMobileNavigationButtonAccess().getGroup_3_1(), "rule__UiMobileNavigationButton__Group_3_1__0");
					put(grammarAccess.getUiMobileSwitchAccess().getGroup(), "rule__UiMobileSwitch__Group__0");
					put(grammarAccess.getUiMobileSwitchAccess().getGroup_3(), "rule__UiMobileSwitch__Group_3__0");
					put(grammarAccess.getUiLabelAccess().getGroup(), "rule__UiLabel__Group__0");
					put(grammarAccess.getUiLabelAccess().getGroup_3(), "rule__UiLabel__Group_3__0");
					...
					put(grammarAccess.getUiOptionsGroupAccess().getGroup_3(), "rule__UiOptionsGroup__Group_3__0");
					put(grammarAccess.getUiOptionsGroupAccess().getGroup_3_1_0(), "rule__UiOptionsGroup__Group_3_1_0__0");
					put(grammarAccess.getUiOptionsGroupAccess().getGroup_3_1_1(), "rule__UiOptionsGroup__Group_3_1_1__0");
					put(grammarAccess.getUiOptionsGroupAccess().getGroup_3_1_2(), "rule__UiOptionsGroup__Group_3_1_2__0");
					put(grammarAccess.getUiOptionsGroupAccess().getGroup_3_1_3(), "rule__UiOptionsGroup__Group_3_1_3__0");
					...
					put(grammarAccess.getUiVisibilityProcessorAccess().getGroup_6(), "rule__UiVisibilityProcessor__Group_6__0");
					put(grammarAccess.getUiVisibilityProcessorAccess().getGroup_7(), "rule__UiVisibilityProcessor__Group_7__0");
					put(grammarAccess.getUiVisibilityPropertiesAssignmentAccess().getGroup(), "rule__UiVisibilityPropertiesAssignment__Group__0");
					put(grammarAccess.getUiVisibilityPropertyAccess().getGroup(), "rule__UiVisibilityProperty__Group__0");
					...
					put(grammarAccess.getUiIDEViewAccess().getViewSetAssignment_3_1(), "rule__UiIDEView__ViewSetAssignment_3_1");
					...
					put(grammarAccess.getUiIDEViewAccess().getBindingEndpointAliasAssignment_6_0(), "rule__UiIDEView__BindingEndpointAliasAssignment_6_0");
					put(grammarAccess.getUiIDEViewAccess().getBindingsAssignment_6_1(), "rule__UiIDEView__BindingsAssignment_6_1");
					put(grammarAccess.getUiIDEViewAccess().getValidatorAssignmentsAssignment_6_2(), "rule__UiIDEView__ValidatorAssignmentsAssignment_6_2");
					put(grammarAccess.getUiMobileViewAccess().getNameAssignment_1(), "rule__UiMobileView__NameAssignment_1");
					put(grammarAccess.getUiMobileViewAccess().getViewSetAssignment_3_1(), "rule__UiMobileView__ViewSetAssignment_3_1");
					...
					put(grammarAccess.getUiMobileViewAccess().getBindingEndpointAliasAssignment_6_0(), "rule__UiMobileView__BindingEndpointAliasAssignment_6_0");
					put(grammarAccess.getUiMobileViewAccess().getBindingsAssignment_6_1(), "rule__UiMobileView__BindingsAssignment_6_1");
					put(grammarAccess.getUiMobileViewAccess().getValidatorAssignmentsAssignment_6_2(), "rule__UiMobileView__ValidatorAssignmentsAssignment_6_2");
					...
					put(grammarAccess.getUiGridLayoutAccess().getProcessorAssignmentAssignment_7(), "rule__UiGridLayout__ProcessorAssignmentAssignment_7");
					...
					put(grammarAccess.getUiGridLayoutAssigmentAccess().getElementAssignment(), "rule__UiGridLayoutAssigment__ElementAssignment");
					put(grammarAccess.getUiFormLayoutAccess().getNameAssignment_2(), "rule__UiFormLayout__NameAssignment_2");
					put(grammarAccess.getUiFormLayoutAccess().getContentsAssignment_4(), "rule__UiFormLayout__ContentsAssignment_4");
					put(grammarAccess.getUiFormLayoutAccess().getBindingsAssignment_5(), "rule__UiFormLayout__BindingsAssignment_5");
					put(grammarAccess.getUiFormLayoutAccess().getProcessorAssignmentAssignment_6(), "rule__UiFormLayout__ProcessorAssignmentAssignment_6");
					put(grammarAccess.getUiFormLayoutAssigmentAccess().getElementAssignment(), "rule__UiFormLayoutAssigment__ElementAssignment");
					put(grammarAccess.getUiVerticalLayoutAccess().getFillVerticalAssignment_2_1(), "rule__UiVerticalLayout__FillVerticalAssignment_2_1");
					...
					put(grammarAccess.getUiVerticalLayoutAccess().getProcessorAssignmentAssignment_7(), "rule__UiVerticalLayout__ProcessorAssignmentAssignment_7");
					put(grammarAccess.getUiVerticalLayoutAssigmentAccess().getElementAssignment(), "rule__UiVerticalLayoutAssigment__ElementAssignment");
					put(grammarAccess.getUiHorizontalLayoutAccess().getFillHorizontalAssignment_2_1(), "rule__UiHorizontalLayout__FillHorizontalAssignment_2_1");
					...
					put(grammarAccess.getUiHorizontalLayoutAccess().getProcessorAssignmentAssignment_7(), "rule__UiHorizontalLayout__ProcessorAssignmentAssignment_7");
					put(grammarAccess.getUiHorizontalLayoutAssigmentAccess().getElementAssignment(), "rule__UiHorizontalLayoutAssigment__ElementAssignment");
					put(grammarAccess.getUiMobileHorizontalButtonGroupAccess().getNameAssignment_2(), "rule__UiMobileHorizontalButtonGroup__NameAssignment_2");
					put(grammarAccess.getUiMobileHorizontalButtonGroupAccess().getContentsAssignment_4(), "rule__UiMobileHorizontalButtonGroup__ContentsAssignment_4");
					put(grammarAccess.getUiMobileHorizontalButtonGroupAccess().getProcessorAssignmentAssignment_5(), "rule__UiMobileHorizontalButtonGroup__ProcessorAssignmentAssignment_5");
					...
					put(grammarAccess.getUiMobileVerticalComponentGroupAccess().getNameAssignment_2(), "rule__UiMobileVerticalComponentGroup__NameAssignment_2");
					put(grammarAccess.getUiMobileVerticalComponentGroupAccess().getContentsAssignment_4(), "rule__UiMobileVerticalComponentGroup__ContentsAssignment_4");
					put(grammarAccess.getUiMobileVerticalComponentGroupAccess().getBindingsAssignment_5(), "rule__UiMobileVerticalComponentGroup__BindingsAssignment_5");
					put(grammarAccess.getUiMobileVerticalComponentGroupAccess().getProcessorAssignmentAssignment_6(), "rule__UiMobileVerticalComponentGroup__ProcessorAssignmentAssignment_6");
					...
					put(grammarAccess.getUiMobileTabSheetAccess().getNameAssignment_2(), "rule__UiMobileTabSheet__NameAssignment_2");
					put(grammarAccess.getUiMobileTabSheetAccess().getTabsAssignment_4(), "rule__UiMobileTabSheet__TabsAssignment_4");
					put(grammarAccess.getUiMobileTabSheetAccess().getBindingsAssignment_5(), "rule__UiMobileTabSheet__BindingsAssignment_5");
					put(grammarAccess.getUiMobileTabSheetAccess().getProcessorAssignmentAssignment_6(), "rule__UiMobileTabSheet__ProcessorAssignmentAssignment_6");
					...
					put(grammarAccess.getUiTabSheetAccess().getNameAssignment_2(), "rule__UiTabSheet__NameAssignment_2");
					put(grammarAccess.getUiTabSheetAccess().getTabsAssignment_4(), "rule__UiTabSheet__TabsAssignment_4");
					put(grammarAccess.getUiTabSheetAccess().getBindingsAssignment_5(), "rule__UiTabSheet__BindingsAssignment_5");
					put(grammarAccess.getUiTabSheetAccess().getProcessorAssignmentAssignment_6(), "rule__UiTabSheet__ProcessorAssignmentAssignment_6");
					...
					put(grammarAccess.getUiDialogAccess().getNameAssignment_2(), "rule__UiDialog__NameAssignment_2");
					put(grammarAccess.getUiDialogAccess().getJvmTypeAssignment_4_1(), "rule__UiDialog__JvmTypeAssignment_4_1");
					put(grammarAccess.getUiDialogAccess().getContentAssignment_5_0(), "rule__UiDialog__ContentAssignment_5_0");
					put(grammarAccess.getUiDialogAccess().getBindingsAssignment_6(), "rule__UiDialog__BindingsAssignment_6");
					put(grammarAccess.getUiDialogAccess().getProcessorAssignmentAssignment_7(), "rule__UiDialog__ProcessorAssignmentAssignment_7");
					put(grammarAccess.getUiDialogAssignmentAccess().getElementAssignment(), "rule__UiDialogAssignment__ElementAssignment");
					put(grammarAccess.getUiSearchDialogAccess().getNameAssignment_2(), "rule__UiSearchDialog__NameAssignment_2");
					put(grammarAccess.getUiSearchDialogAccess().getJvmTypeAssignment_4_1(), "rule__UiSearchDialog__JvmTypeAssignment_4_1");
					put(grammarAccess.getUiSearchDialogAccess().getSearchFieldsAssignment_5_2(), "rule__UiSearchDialog__SearchFieldsAssignment_5_2");
					put(grammarAccess.getUiSearchDialogAccess().getContentAssignment_6_2(), "rule__UiSearchDialog__ContentAssignment_6_2");
					put(grammarAccess.getUiSearchDialogAccess().getBindingsAssignment_7(), "rule__UiSearchDialog__BindingsAssignment_7");
					put(grammarAccess.getUiSearchDialogAccess().getProcessorAssignmentAssignment_8(), "rule__UiSearchDialog__ProcessorAssignmentAssignment_8");
					...
					put(grammarAccess.getUiMobileNavigationPageAccess().getNameAssignment_2(), "rule__UiMobileNavigationPage__NameAssignment_2");
					put(grammarAccess.getUiMobileNavigationPageAccess().getJvmTypeAssignment_4_1(), "rule__UiMobileNavigationPage__JvmTypeAssignment_4_1");
					put(grammarAccess.getUiMobileNavigationPageAccess().getContentsAssignment_5(), "rule__UiMobileNavigationPage__ContentsAssignment_5");
					put(grammarAccess.getUiMobileNavigationPageAccess().getBindingsAssignment_6(), "rule__UiMobileNavigationPage__BindingsAssignment_6");
					put(grammarAccess.getUiMobileNavigationPageAccess().getProcessorAssignmentAssignment_7(), "rule__UiMobileNavigationPage__ProcessorAssignmentAssignment_7");
					...
					put(grammarAccess.getUiTextFieldAccess().getProcessorAssignmentAssignment_4_2(), "rule__UiTextField__ProcessorAssignmentAssignment_4_2");
					put(grammarAccess.getUiSearchFieldAccess().getPropertyAssignment_2(), "rule__UiSearchField__PropertyAssignment_2");
					put(grammarAccess.getUiTextAreaAccess().getNameAssignment_2(), "rule__UiTextArea__NameAssignment_2");
					put(grammarAccess.getUiTextAreaAccess().getValidatorsAssignment_3_1_0(), "rule__UiTextArea__ValidatorsAssignment_3_1_0");
					put(grammarAccess.getUiTextAreaAccess().getBindingsAssignment_3_1_1(), "rule__UiTextArea__BindingsAssignment_3_1_1");
					put(grammarAccess.getUiTextAreaAccess().getProcessorAssignmentAssignment_3_2(), "rule__UiTextArea__ProcessorAssignmentAssignment_3_2");
					put(grammarAccess.getUiDateFieldAccess().getNameAssignment_2(), "rule__UiDateField__NameAssignment_2");
					put(grammarAccess.getUiDateFieldAccess().getValidatorsAssignment_3_1_0(), "rule__UiDateField__ValidatorsAssignment_3_1_0");
					put(grammarAccess.getUiDateFieldAccess().getBindingsAssignment_3_1_1(), "rule__UiDateField__BindingsAssignment_3_1_1");
					put(grammarAccess.getUiDateFieldAccess().getProcessorAssignmentAssignment_3_2(), "rule__UiDateField__ProcessorAssignmentAssignment_3_2");
					put(grammarAccess.getUiBrowserAccess().getNameAssignment_2(), "rule__UiBrowser__NameAssignment_2");
					put(grammarAccess.getUiBrowserAccess().getValidatorsAssignment_3_1_0(), "rule__UiBrowser__ValidatorsAssignment_3_1_0");
					put(grammarAccess.getUiBrowserAccess().getBindingsAssignment_3_1_1(), "rule__UiBrowser__BindingsAssignment_3_1_1");
					put(grammarAccess.getUiBrowserAccess().getProcessorAssignmentAssignment_3_2(), "rule__UiBrowser__ProcessorAssignmentAssignment_3_2");
					put(grammarAccess.getUiProgressBarAccess().getNameAssignment_2(), "rule__UiProgressBar__NameAssignment_2");
					put(grammarAccess.getUiProgressBarAccess().getValidatorsAssignment_3_1_0(), "rule__UiProgressBar__ValidatorsAssignment_3_1_0");
					put(grammarAccess.getUiProgressBarAccess().getBindingsAssignment_3_1_1(), "rule__UiProgressBar__BindingsAssignment_3_1_1");
					put(grammarAccess.getUiProgressBarAccess().getProcessorAssignmentAssignment_3_2(), "rule__UiProgressBar__ProcessorAssignmentAssignment_3_2");
					put(grammarAccess.getUiImageAccess().getNameAssignment_2(), "rule__UiImage__NameAssignment_2");
					put(grammarAccess.getUiImageAccess().getValueAssignment_3_1_1(), "rule__UiImage__ValueAssignment_3_1_1");
					put(grammarAccess.getUiImageAccess().getBindingsAssignment_3_2(), "rule__UiImage__BindingsAssignment_3_2");
					put(grammarAccess.getUiImageAccess().getProcessorAssignmentAssignment_3_3(), "rule__UiImage__ProcessorAssignmentAssignment_3_3");
					put(grammarAccess.getUiListAccess().getNameAssignment_2(), "rule__UiList__NameAssignment_2");
					put(grammarAccess.getUiTableAccess().getNameAssignment_2(), "rule__UiTable__NameAssignment_2");
					put(grammarAccess.getUiTableAccess().getJvmTypeAssignment_3_1_0_1(), "rule__UiTable__JvmTypeAssignment_3_1_0_1");
					put(grammarAccess.getUiTableAccess().getSelectionTypeAssignment_3_1_1_1(), "rule__UiTable__SelectionTypeAssignment_3_1_1_1");
					put(grammarAccess.getUiTableAccess().getItemImagePropertyAssignment_3_1_2_1(), "rule__UiTable__ItemImagePropertyAssignment_3_1_2_1");
					put(grammarAccess.getUiTableAccess().getColumnAssignmentAssignment_3_2(), "rule__UiTable__ColumnAssignmentAssignment_3_2");
					put(grammarAccess.getUiTableAccess().getValidatorsAssignment_3_3_0(), "rule__UiTable__ValidatorsAssignment_3_3_0");
					put(grammarAccess.getUiTableAccess().getBindingsAssignment_3_3_1(), "rule__UiTable__BindingsAssignment_3_3_1");
					put(grammarAccess.getUiTableAccess().getProcessorAssignmentAssignment_3_4(), "rule__UiTable__ProcessorAssignmentAssignment_3_4");
					put(grammarAccess.getUiComboBoxAccess().getNameAssignment_2(), "rule__UiComboBox__NameAssignment_2");
					put(grammarAccess.getUiComboBoxAccess().getJvmTypeAssignment_3_1_0_1(), "rule__UiComboBox__JvmTypeAssignment_3_1_0_1");
					put(grammarAccess.getUiComboBoxAccess().getItemCaptionPropertyAssignment_3_1_1_1(), "rule__UiComboBox__ItemCaptionPropertyAssignment_3_1_1_1");
					put(grammarAccess.getUiComboBoxAccess().getItemImagePropertyAssignment_3_1_2_1(), "rule__UiComboBox__ItemImagePropertyAssignment_3_1_2_1");
					put(grammarAccess.getUiComboBoxAccess().getValidatorsAssignment_3_2_0(), "rule__UiComboBox__ValidatorsAssignment_3_2_0");
					put(grammarAccess.getUiComboBoxAccess().getBindingsAssignment_3_2_1(), "rule__UiComboBox__BindingsAssignment_3_2_1");
					put(grammarAccess.getUiComboBoxAccess().getProcessorAssignmentAssignment_3_3(), "rule__UiComboBox__ProcessorAssignmentAssignment_3_3");
					put(grammarAccess.getUiButtonAccess().getNameAssignment_2(), "rule__UiButton__NameAssignment_2");
					put(grammarAccess.getUiMobileNavigationButtonAccess().getNameAssignment_2(), "rule__UiMobileNavigationButton__NameAssignment_2");
					put(grammarAccess.getUiMobileNavigationButtonAccess().getTargetPageAssignment_3_0(), "rule__UiMobileNavigationButton__TargetPageAssignment_3_0");
					put(grammarAccess.getUiMobileNavigationButtonAccess().getTargetPageAliasAssignment_3_1_1(), "rule__UiMobileNavigationButton__TargetPageAliasAssignment_3_1_1");
					put(grammarAccess.getUiMobileSwitchAccess().getNameAssignment_2(), "rule__UiMobileSwitch__NameAssignment_2");
					put(grammarAccess.getUiMobileSwitchAccess().getProcessorAssignmentAssignment_3_1(), "rule__UiMobileSwitch__ProcessorAssignmentAssignment_3_1");
					put(grammarAccess.getUiMobileSwitchAccess().getValidatorsAssignment_3_2_0(), "rule__UiMobileSwitch__ValidatorsAssignment_3_2_0");
					put(grammarAccess.getUiMobileSwitchAccess().getBindingsAssignment_3_2_1(), "rule__UiMobileSwitch__BindingsAssignment_3_2_1");
					put(grammarAccess.getUiLabelAccess().getNameAssignment_2(), "rule__UiLabel__NameAssignment_2");
					put(grammarAccess.getUiLabelAccess().getProcessorAssignmentAssignment_3_1(), "rule__UiLabel__ProcessorAssignmentAssignment_3_1");
					put(grammarAccess.getUiLabelAccess().getBindingsAssignment_3_2(), "rule__UiLabel__BindingsAssignment_3_2");
					put(grammarAccess.getUiDecimalFieldAccess().getGroupingAssignment_2_1_0(), "rule__UiDecimalField__GroupingAssignment_2_1_0");
					put(grammarAccess.getUiDecimalFieldAccess().getMarkNegativeAssignment_2_1_1(), "rule__UiDecimalField__MarkNegativeAssignment_2_1_1");
					put(grammarAccess.getUiDecimalFieldAccess().getPrecisionAssignment_2_1_2_1(), "rule__UiDecimalField__PrecisionAssignment_2_1_2_1");
					...
					put(grammarAccess.getUiDecimalFieldAccess().getProcessorAssignmentAssignment_4_2(), "rule__UiDecimalField__ProcessorAssignmentAssignment_4_2");
					put(grammarAccess.getUiOptionsGroupAccess().getNameAssignment_2(), "rule__UiOptionsGroup__NameAssignment_2");
					put(grammarAccess.getUiOptionsGroupAccess().getJvmTypeAssignment_3_1_0_1(), "rule__UiOptionsGroup__JvmTypeAssignment_3_1_0_1");
					put(grammarAccess.getUiOptionsGroupAccess().getSelectionTypeAssignment_3_1_1_1(), "rule__UiOptionsGroup__SelectionTypeAssignment_3_1_1_1");
					put(grammarAccess.getUiOptionsGroupAccess().getItemCaptionPropertyAssignment_3_1_2_1(), "rule__UiOptionsGroup__ItemCaptionPropertyAssignment_3_1_2_1");
					put(grammarAccess.getUiOptionsGroupAccess().getItemImagePropertyAssignment_3_1_3_1(), "rule__UiOptionsGroup__ItemImagePropertyAssignment_3_1_3_1");
					put(grammarAccess.getUiOptionsGroupAccess().getValidatorsAssignment_3_2_0(), "rule__UiOptionsGroup__ValidatorsAssignment_3_2_0");
					put(grammarAccess.getUiOptionsGroupAccess().getBindingsAssignment_3_2_1(), "rule__UiOptionsGroup__BindingsAssignment_3_2_1");
					put(grammarAccess.getUiOptionsGroupAccess().getProcessorAssignmentAssignment_3_3(), "rule__UiOptionsGroup__ProcessorAssignmentAssignment_3_3");
					put(grammarAccess.getUiColumnsAssignmentAccess().getColumnsAssignment_3(), "rule__UiColumnsAssignment__ColumnsAssignment_3");
					put(grammarAccess.getUiColumnAccess().getJvmFieldAssignment_2(), "rule__UiColumn__JvmFieldAssignment_2");
					put(grammarAccess.getUiColumnAccess().getIconNameAssignment_3_1(), "rule__UiColumn__IconNameAssignment_3_1");
					put(grammarAccess.getUiNumericFieldAccess().getGroupingAssignment_2_1_0(), "rule__UiNumericField__GroupingAssignment_2_1_0");
					put(grammarAccess.getUiNumericFieldAccess().getMarkNegativeAssignment_2_1_1(), "rule__UiNumericField__MarkNegativeAssignment_2_1_1");
					...
					put(grammarAccess.getUiNumericFieldAccess().getProcessorAssignmentAssignment_4_2(), "rule__UiNumericField__ProcessorAssignmentAssignment_4_2");
					put(grammarAccess.getUiCheckBoxAccess().getNameAssignment_2(), "rule__UiCheckBox__NameAssignment_2");
					put(grammarAccess.getUiCheckBoxAccess().getValidatorsAssignment_3_1_0(), "rule__UiCheckBox__ValidatorsAssignment_3_1_0");
					put(grammarAccess.getUiCheckBoxAccess().getBindingsAssignment_3_1_1(), "rule__UiCheckBox__BindingsAssignment_3_1_1");
					put(grammarAccess.getUiCheckBoxAccess().getProcessorAssignmentAssignment_3_2(), "rule__UiCheckBox__ProcessorAssignmentAssignment_3_2");
					...
					put(grammarAccess.getUiVisibilityProcessorAccess().getPropertiesAssignmentAssignment_4(), "rule__UiVisibilityProcessor__PropertiesAssignmentAssignment_4");
					put(grammarAccess.getUiVisibilityProcessorAccess().getBindingAliasAssignment_6_2_0(), "rule__UiVisibilityProcessor__BindingAliasAssignment_6_2_0");
					put(grammarAccess.getUiVisibilityProcessorAccess().getChangeTriggerAssignment_6_2_1(), "rule__UiVisibilityProcessor__ChangeTriggerAssignment_6_2_1");
					put(grammarAccess.getUiVisibilityProcessorAccess().getRuleAssignment_7_1(), "rule__UiVisibilityProcessor__RuleAssignment_7_1");
					...
					put(grammarAccess.getUiVisibilityPropertiesAssignmentAccess().getPropertiesAssignment_1(), "rule__UiVisibilityPropertiesAssignment__PropertiesAssignment_1");
					put(grammarAccess.getUiVisibilityPropertyAccess().getBindableDefAssignment_0(), "rule__UiVisibilityProperty__BindableDefAssignment_0");
					put(grammarAccess.getUiVisibilityPropertyAccess().getAssignmentExpressionAssignment_2(), "rule__UiVisibilityProperty__AssignmentExpressionAssignment_2");
					...
					put(grammarAccess.getUiOptionsGroupAccess().getUnorderedGroup_3_1(), "rule__UiOptionsGroup__UnorderedGroup_3_1");
