		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUiTableAccess().getGroup_3_1(), "rule__UiTable__Group_3_1__0");
					put(grammarAccess.getUiTableAccess().getGroup_3_2(), "rule__UiTable__Group_3_2__0");
					put(grammarAccess.getUiTableAccess().getGroup_3_3(), "rule__UiTable__Group_3_3__0");
					...
					put(grammarAccess.getUiComboBoxAccess().getGroup_3_1(), "rule__UiComboBox__Group_3_1__0");
					put(grammarAccess.getUiComboBoxAccess().getGroup_3_2(), "rule__UiComboBox__Group_3_2__0");
					put(grammarAccess.getUiComboBoxAccess().getGroup_3_3(), "rule__UiComboBox__Group_3_3__0");
					...
					put(grammarAccess.getUiDecimalFieldAccess().getGroup_3(), "rule__UiDecimalField__Group_3__0");
					put(grammarAccess.getUiRadioButtonGroupAccess().getGroup(), "rule__UiRadioButtonGroup__Group__0");
					put(grammarAccess.getUiRadioButtonAssignmentAccess().getGroup(), "rule__UiRadioButtonAssignment__Group__0");
					put(grammarAccess.getUiColumnAssignmentsAccess().getGroup(), "rule__UiColumnAssignments__Group__0");
					...
					put(grammarAccess.getUiVerticalLayoutAccess().getNameAssignment_2(), "rule__UiVerticalLayout__NameAssignment_2");
					put(grammarAccess.getUiVerticalLayoutAccess().getContentsAssignment_4(), "rule__UiVerticalLayout__ContentsAssignment_4");
					...
					put(grammarAccess.getUiHorizontalLayoutAccess().getNameAssignment_2(), "rule__UiHorizontalLayout__NameAssignment_2");
					put(grammarAccess.getUiHorizontalLayoutAccess().getContentsAssignment_4(), "rule__UiHorizontalLayout__ContentsAssignment_4");
					...
					put(grammarAccess.getUiTableAccess().getJvmTypeAssignment_3_1_1(), "rule__UiTable__JvmTypeAssignment_3_1_1");
					put(grammarAccess.getUiTableAccess().getSelectionTypeAssignment_3_2_1(), "rule__UiTable__SelectionTypeAssignment_3_2_1");
					put(grammarAccess.getUiTableAccess().getItemImagePropertyAssignment_3_3_1(), "rule__UiTable__ItemImagePropertyAssignment_3_3_1");
					put(grammarAccess.getUiTableAccess().getColumnAssignmentAssignment_3_4(), "rule__UiTable__ColumnAssignmentAssignment_3_4");
					put(grammarAccess.getUiTableAccess().getBindingsAssignment_3_5(), "rule__UiTable__BindingsAssignment_3_5");
					put(grammarAccess.getUiComboBoxAccess().getNameAssignment_2(), "rule__UiComboBox__NameAssignment_2");
					put(grammarAccess.getUiComboBoxAccess().getJvmTypeAssignment_3_1_1(), "rule__UiComboBox__JvmTypeAssignment_3_1_1");
					put(grammarAccess.getUiComboBoxAccess().getItemCaptionPropertyAssignment_3_2_1(), "rule__UiComboBox__ItemCaptionPropertyAssignment_3_2_1");
					put(grammarAccess.getUiComboBoxAccess().getItemImagePropertyAssignment_3_3_1(), "rule__UiComboBox__ItemImagePropertyAssignment_3_3_1");
					put(grammarAccess.getUiComboBoxAccess().getBindingsAssignment_3_4(), "rule__UiComboBox__BindingsAssignment_3_4");
					...
					put(grammarAccess.getUiDecimalFieldAccess().getNameAssignment_2(), "rule__UiDecimalField__NameAssignment_2");
					put(grammarAccess.getUiDecimalFieldAccess().getValidatorsAssignment_3_1(), "rule__UiDecimalField__ValidatorsAssignment_3_1");
					put(grammarAccess.getUiRadioButtonGroupAccess().getNameAssignment_2(), "rule__UiRadioButtonGroup__NameAssignment_2");
					put(grammarAccess.getUiRadioButtonGroupAccess().getButtonsAssignment_4(), "rule__UiRadioButtonGroup__ButtonsAssignment_4");
					put(grammarAccess.getUiRadioButtonAssignmentAccess().getNameAssignment_1(), "rule__UiRadioButtonAssignment__NameAssignment_1");
					put(grammarAccess.getUiRadioButtonAssignmentAccess().getElementAssignment_2(), "rule__UiRadioButtonAssignment__ElementAssignment_2");
					put(grammarAccess.getUiColumnAssignmentsAccess().getColumnsAssignment_3(), "rule__UiColumnAssignments__ColumnsAssignment_3");
