		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUiVisibilityProcessorAssignmentAccess().getAlternatives_1(), "rule__UiVisibilityProcessorAssignment__Alternatives_1");
					put(grammarAccess.getUiVisibilityPropertiesAssignmentAccess().getAlternatives_1(), "rule__UiVisibilityPropertiesAssignment__Alternatives_1");
					...
					put(grammarAccess.getUiVisibilityProcessorDefAccess().getGroup(), "rule__UiVisibilityProcessorDef__Group__0");
					put(grammarAccess.getUiVisibilityProcessorAssignmentAccess().getGroup(), "rule__UiVisibilityProcessorAssignment__Group__0");
					put(grammarAccess.getUiVisibilityProcessorAssignmentAccess().getGroup_1_1(), "rule__UiVisibilityProcessorAssignment__Group_1_1__0");
					put(grammarAccess.getUiVisibilityPropertiesAccess().getGroup(), "rule__UiVisibilityProperties__Group__0");
					put(grammarAccess.getUiVisibilityPropertiesDefAccess().getGroup(), "rule__UiVisibilityPropertiesDef__Group__0");
					put(grammarAccess.getUiVisibilityPropertiesAssignmentAccess().getGroup(), "rule__UiVisibilityPropertiesAssignment__Group__0");
					put(grammarAccess.getUiVisibilityPropertiesAssignmentAccess().getGroup_1_1(), "rule__UiVisibilityPropertiesAssignment__Group_1_1__0");
					...
					put(grammarAccess.getUiGridLayoutAccess().getGroup_2_1(), "rule__UiGridLayout__Group_2_1__0");
					...
					put(grammarAccess.getUiVisibilityProcessorAccess().getPropertiesAssignmentAssignment_6(), "rule__UiVisibilityProcessor__PropertiesAssignmentAssignment_6");
					put(grammarAccess.getUiVisibilityProcessorDefAccess().getProcessorAssignment_1(), "rule__UiVisibilityProcessorDef__ProcessorAssignment_1");
					put(grammarAccess.getUiVisibilityProcessorAssignmentAccess().getProcessorAssignment_1_0(), "rule__UiVisibilityProcessorAssignment__ProcessorAssignment_1_0");
					put(grammarAccess.getUiVisibilityProcessorAssignmentAccess().getProcessorAliasAssignment_1_1_0(), "rule__UiVisibilityProcessorAssignment__ProcessorAliasAssignment_1_1_0");
					put(grammarAccess.getUiVisibilityPropertiesAccess().getNameAssignment_1(), "rule__UiVisibilityProperties__NameAssignment_1");
					put(grammarAccess.getUiVisibilityPropertiesDefAccess().getPropertiesAssignment_1(), "rule__UiVisibilityPropertiesDef__PropertiesAssignment_1");
					put(grammarAccess.getUiVisibilityPropertiesAssignmentAccess().getPropertiesAssignment_1_0(), "rule__UiVisibilityPropertiesAssignment__PropertiesAssignment_1_0");
					put(grammarAccess.getUiVisibilityPropertiesAssignmentAccess().getPropertyAliasAssignment_1_1_0(), "rule__UiVisibilityPropertiesAssignment__PropertyAliasAssignment_1_1_0");
					...
					put(grammarAccess.getUiXbaseVisibilityRuleAccess().getExpressionAssignment_2(), "rule__UiXbaseVisibilityRule__ExpressionAssignment_2");
					...
					put(grammarAccess.getUiBindingEndpointDefAccess().getSemanticEndpointAssignment_2(), "rule__UiBindingEndpointDef__SemanticEndpointAssignment_2");
					...
					put(grammarAccess.getUiGridLayoutAccess().getColumnsAssignment_2_1_1(), "rule__UiGridLayout__ColumnsAssignment_2_1_1");
					...
					put(grammarAccess.getUiGridLayoutAccess().getProcessorAssignmentAssignment_6(), "rule__UiGridLayout__ProcessorAssignmentAssignment_6");
					...
					put(grammarAccess.getUiTextFieldAccess().getProcessorAssignmentAssignment_3_2(), "rule__UiTextField__ProcessorAssignmentAssignment_3_2");
					...
					put(grammarAccess.getUiNumericFieldAccess().getProcessorAssignmentAssignment_3_2(), "rule__UiNumericField__ProcessorAssignmentAssignment_3_2");
