	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getEmbeddableAccess().getAlternatives(), "rule__Embeddable__Alternatives");
					put(grammarAccess.getFieldAccess().getAlternatives(), "rule__Field__Alternatives");
					put(grammarAccess.getValidatorAccess().getAlternatives(), "rule__Validator__Alternatives");
					...
					put(grammarAccess.getGGridLayoutAccess().getGroup_2_1_0(), "rule__GGridLayout__Group_2_1_0__0");
					put(grammarAccess.getGGridLayoutAssigmentAccess().getGroup(), "rule__GGridLayoutAssigment__Group__0");
					put(grammarAccess.getGGridLayoutAssigmentAccess().getGroup_1_0(), "rule__GGridLayoutAssigment__Group_1_0__0");
					put(grammarAccess.getGGridLayoutAssigmentAccess().getGroup_1_1(), "rule__GGridLayoutAssigment__Group_1_1__0");
					put(grammarAccess.getPointAccess().getGroup(), "rule__Point__Group__0");
					put(grammarAccess.getGridLayoutCellStyleAccess().getGroup(), "rule__GridLayoutCellStyle__Group__0");
					put(grammarAccess.getGridLayoutCellStyleAccess().getGroup_1_0(), "rule__GridLayoutCellStyle__Group_1_0__0");
					put(grammarAccess.getGridLayoutCellStyleAccess().getGroup_1_1(), "rule__GridLayoutCellStyle__Group_1_1__0");
					put(grammarAccess.getGridLayoutCellStyleAccess().getGroup_1_2(), "rule__GridLayoutCellStyle__Group_1_2__0");
					put(grammarAccess.getSpanInfoAccess().getGroup(), "rule__SpanInfo__Group__0");
					put(grammarAccess.getSpanInfoAccess().getGroup_1_0_0(), "rule__SpanInfo__Group_1_0_0__0");
					put(grammarAccess.getSpanInfoAccess().getGroup_1_0_1(), "rule__SpanInfo__Group_1_0_1__0");
					put(grammarAccess.getSpanInfoAccess().getGroup_1_1_0(), "rule__SpanInfo__Group_1_1_0__0");
					put(grammarAccess.getSpanInfoAccess().getGroup_1_1_1(), "rule__SpanInfo__Group_1_1_1__0");
					put(grammarAccess.getGTextFieldAccess().getGroup(), "rule__GTextField__Group__0");
					put(grammarAccess.getGTextFieldAccess().getGroup_3(), "rule__GTextField__Group_3__0");
					put(grammarAccess.getGTextFieldAccess().getGroup_3_1_0(), "rule__GTextField__Group_3_1_0__0");
					put(grammarAccess.getGTextFieldAccess().getGroup_3_1_1(), "rule__GTextField__Group_3_1_1__0");
					put(grammarAccess.getGTextFieldAccess().getGroup_3_1_2(), "rule__GTextField__Group_3_1_2__0");
					put(grammarAccess.getGTextAreaAccess().getGroup(), "rule__GTextArea__Group__0");
					put(grammarAccess.getGTextAreaAccess().getGroup_3(), "rule__GTextArea__Group_3__0");
					put(grammarAccess.getGTextAreaAccess().getGroup_3_1_0(), "rule__GTextArea__Group_3_1_0__0");
					put(grammarAccess.getGTextAreaAccess().getGroup_3_1_1(), "rule__GTextArea__Group_3_1_1__0");
					put(grammarAccess.getGTextAreaAccess().getGroup_3_1_2(), "rule__GTextArea__Group_3_1_2__0");
					put(grammarAccess.getGTableAccess().getGroup(), "rule__GTable__Group__0");
					put(grammarAccess.getGTableAccess().getGroup_4_0(), "rule__GTable__Group_4_0__0");
					put(grammarAccess.getGTableAccess().getGroup_4_1(), "rule__GTable__Group_4_1__0");
					put(grammarAccess.getGTableAccess().getGroup_4_2(), "rule__GTable__Group_4_2__0");
					put(grammarAccess.getGTableAccess().getGroup_4_3(), "rule__GTable__Group_4_3__0");
					put(grammarAccess.getGTableAccess().getGroup_4_4(), "rule__GTable__Group_4_4__0");
					put(grammarAccess.getGTableAccess().getGroup_4_5(), "rule__GTable__Group_4_5__0");
					put(grammarAccess.getGTableAccess().getGroup_4_6(), "rule__GTable__Group_4_6__0");
					put(grammarAccess.getGTreeAccess().getGroup(), "rule__GTree__Group__0");
					put(grammarAccess.getGTreeAccess().getGroup_4_0(), "rule__GTree__Group_4_0__0");
					put(grammarAccess.getGTreeAccess().getGroup_4_1(), "rule__GTree__Group_4_1__0");
					put(grammarAccess.getGTreeAccess().getGroup_4_2(), "rule__GTree__Group_4_2__0");
					put(grammarAccess.getGTreeAccess().getGroup_4_3(), "rule__GTree__Group_4_3__0");
					put(grammarAccess.getGTreeAccess().getGroup_4_4(), "rule__GTree__Group_4_4__0");
					put(grammarAccess.getGTreeAccess().getGroup_4_5(), "rule__GTree__Group_4_5__0");
					put(grammarAccess.getGTreeAccess().getGroup_4_6(), "rule__GTree__Group_4_6__0");
					...
					put(grammarAccess.getViewSetAccess().getBeanSlotsAssignment_3_0_2(), "rule__ViewSet__BeanSlotsAssignment_3_0_2");
					put(grammarAccess.getViewSetAccess().getViewsAssignment_3_1(), "rule__ViewSet__ViewsAssignment_3_1");
					...
					put(grammarAccess.getGGridLayoutAccess().getFillHorizontalAssignment_2_1_1(), "rule__GGridLayout__FillHorizontalAssignment_2_1_1");
					put(grammarAccess.getGGridLayoutAccess().getFillVerticalAssignment_2_1_2(), "rule__GGridLayout__FillVerticalAssignment_2_1_2");
					put(grammarAccess.getGGridLayoutAccess().getSpacingAssignment_2_1_3(), "rule__GGridLayout__SpacingAssignment_2_1_3");
					put(grammarAccess.getGGridLayoutAccess().getMarginAssignment_2_1_4(), "rule__GGridLayout__MarginAssignment_2_1_4");
					put(grammarAccess.getGGridLayoutAccess().getNameAssignment_3(), "rule__GGridLayout__NameAssignment_3");
					put(grammarAccess.getGGridLayoutAccess().getContentsAssignment_5(), "rule__GGridLayout__ContentsAssignment_5");
					put(grammarAccess.getGGridLayoutAssigmentAccess().getElementAssignment_0(), "rule__GGridLayoutAssigment__ElementAssignment_0");
					put(grammarAccess.getGGridLayoutAssigmentAccess().getAlignmentAssignment_1_0_1(), "rule__GGridLayoutAssigment__AlignmentAssignment_1_0_1");
					put(grammarAccess.getGGridLayoutAssigmentAccess().getFromAssignment_1_1_1(), "rule__GGridLayoutAssigment__FromAssignment_1_1_1");
					put(grammarAccess.getGGridLayoutAssigmentAccess().getToAssignment_1_1_3(), "rule__GGridLayoutAssigment__ToAssignment_1_1_3");
					...
					put(grammarAccess.getGridLayoutCellStyleAccess().getTargetAssignment_1_0_1(), "rule__GridLayoutCellStyle__TargetAssignment_1_0_1");
					put(grammarAccess.getGridLayoutCellStyleAccess().getAlignmentAssignment_1_1_1(), "rule__GridLayoutCellStyle__AlignmentAssignment_1_1_1");
					put(grammarAccess.getGridLayoutCellStyleAccess().getSpanInfoAssignment_1_2_1(), "rule__GridLayoutCellStyle__SpanInfoAssignment_1_2_1");
					put(grammarAccess.getSpanInfoAccess().getColumnFromAssignment_1_0_0_1(), "rule__SpanInfo__ColumnFromAssignment_1_0_0_1");
					put(grammarAccess.getSpanInfoAccess().getColumnToAssignment_1_0_1_1(), "rule__SpanInfo__ColumnToAssignment_1_0_1_1");
					put(grammarAccess.getSpanInfoAccess().getRowFromAssignment_1_1_0_1(), "rule__SpanInfo__RowFromAssignment_1_1_0_1");
					put(grammarAccess.getSpanInfoAccess().getRowToAssignment_1_1_1_1(), "rule__SpanInfo__RowToAssignment_1_1_1_1");
					put(grammarAccess.getGTextFieldAccess().getNameAssignment_2(), "rule__GTextField__NameAssignment_2");
					put(grammarAccess.getGTextFieldAccess().getDatatypeAssignment_3_1_0_1(), "rule__GTextField__DatatypeAssignment_3_1_0_1");
					put(grammarAccess.getGTextFieldAccess().getDatadescriptionAssignment_3_1_1_1(), "rule__GTextField__DatadescriptionAssignment_3_1_1_1");
					put(grammarAccess.getGTextFieldAccess().getValueAssignment_3_1_2_1(), "rule__GTextField__ValueAssignment_3_1_2_1");
					put(grammarAccess.getGTextAreaAccess().getNameAssignment_2(), "rule__GTextArea__NameAssignment_2");
					put(grammarAccess.getGTextAreaAccess().getDatatypeAssignment_3_1_0_1(), "rule__GTextArea__DatatypeAssignment_3_1_0_1");
					put(grammarAccess.getGTextAreaAccess().getDatadescriptionAssignment_3_1_1_1(), "rule__GTextArea__DatadescriptionAssignment_3_1_1_1");
					put(grammarAccess.getGTextAreaAccess().getValueAssignment_3_1_2_1(), "rule__GTextArea__ValueAssignment_3_1_2_1");
					put(grammarAccess.getGTableAccess().getNameAssignment_2(), "rule__GTable__NameAssignment_2");
					put(grammarAccess.getGTableAccess().getDatatypeAssignment_4_0_1(), "rule__GTable__DatatypeAssignment_4_0_1");
					put(grammarAccess.getGTableAccess().getDatadescriptionAssignment_4_1_1(), "rule__GTable__DatadescriptionAssignment_4_1_1");
					put(grammarAccess.getGTableAccess().getSelectionTypeAssignment_4_2_1(), "rule__GTable__SelectionTypeAssignment_4_2_1");
					put(grammarAccess.getGTableAccess().getJvmTypeAssignment_4_3_1(), "rule__GTable__JvmTypeAssignment_4_3_1");
					put(grammarAccess.getGTableAccess().getCollectionBindingEndpointAssignment_4_4_1(), "rule__GTable__CollectionBindingEndpointAssignment_4_4_1");
					put(grammarAccess.getGTableAccess().getSelectionBindingEndpointAssignment_4_5_1(), "rule__GTable__SelectionBindingEndpointAssignment_4_5_1");
					put(grammarAccess.getGTableAccess().getMultiSelectionBindingEndpointAssignment_4_6_1(), "rule__GTable__MultiSelectionBindingEndpointAssignment_4_6_1");
					put(grammarAccess.getGTreeAccess().getNameAssignment_2(), "rule__GTree__NameAssignment_2");
					put(grammarAccess.getGTreeAccess().getDatatypeAssignment_4_0_1(), "rule__GTree__DatatypeAssignment_4_0_1");
					put(grammarAccess.getGTreeAccess().getDatadescriptionAssignment_4_1_1(), "rule__GTree__DatadescriptionAssignment_4_1_1");
					put(grammarAccess.getGTreeAccess().getSelectionTypeAssignment_4_2_1(), "rule__GTree__SelectionTypeAssignment_4_2_1");
					put(grammarAccess.getGTreeAccess().getJvmTypeAssignment_4_3_1(), "rule__GTree__JvmTypeAssignment_4_3_1");
					put(grammarAccess.getGTreeAccess().getCollectionBindingEndpointAssignment_4_4_1(), "rule__GTree__CollectionBindingEndpointAssignment_4_4_1");
					put(grammarAccess.getGTreeAccess().getSelectionBindingEndpointAssignment_4_5_1(), "rule__GTree__SelectionBindingEndpointAssignment_4_5_1");
					put(grammarAccess.getGTreeAccess().getMultiSelectionBindingEndpointAssignment_4_6_1(), "rule__GTree__MultiSelectionBindingEndpointAssignment_4_6_1");
					put(grammarAccess.getBindingAccess().getEmbeddableAssignment_1(), "rule__Binding__EmbeddableAssignment_1");
					put(grammarAccess.getBindingAccess().getMethodAssignment_3(), "rule__Binding__MethodAssignment_3");
					...
					put(grammarAccess.getGGridLayoutAccess().getUnorderedGroup_2_1(), "rule__GGridLayout__UnorderedGroup_2_1");
					put(grammarAccess.getGGridLayoutAssigmentAccess().getUnorderedGroup_1(), "rule__GGridLayoutAssigment__UnorderedGroup_1");
					put(grammarAccess.getGridLayoutCellStyleAccess().getUnorderedGroup_1(), "rule__GridLayoutCellStyle__UnorderedGroup_1");
					put(grammarAccess.getSpanInfoAccess().getUnorderedGroup_1(), "rule__SpanInfo__UnorderedGroup_1");
					put(grammarAccess.getSpanInfoAccess().getUnorderedGroup_1_0(), "rule__SpanInfo__UnorderedGroup_1_0");
					put(grammarAccess.getSpanInfoAccess().getUnorderedGroup_1_1(), "rule__SpanInfo__UnorderedGroup_1_1");
					put(grammarAccess.getGTextFieldAccess().getUnorderedGroup_3_1(), "rule__GTextField__UnorderedGroup_3_1");
					put(grammarAccess.getGTextAreaAccess().getUnorderedGroup_3_1(), "rule__GTextArea__UnorderedGroup_3_1");
					put(grammarAccess.getGTableAccess().getUnorderedGroup_4(), "rule__GTable__UnorderedGroup_4");
					put(grammarAccess.getGTreeAccess().getUnorderedGroup_4(), "rule__GTree__UnorderedGroup_4");
				}
			};
		}
