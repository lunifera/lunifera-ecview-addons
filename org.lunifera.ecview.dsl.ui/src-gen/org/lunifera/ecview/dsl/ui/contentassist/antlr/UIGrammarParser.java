		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getHorizontalLayoutAccess().getAlternatives_2(), "rule__HorizontalLayout__Alternatives_2");
					put(grammarAccess.getHorizontalLayoutCellStyleAccess().getAlternatives(), "rule__HorizontalLayoutCellStyle__Alternatives");
					put(grammarAccess.getVerticalLayoutAccess().getAlternatives_2(), "rule__VerticalLayout__Alternatives_2");
					put(grammarAccess.getVerticalLayoutCellStyleAccess().getAlternatives(), "rule__VerticalLayoutCellStyle__Alternatives");
					put(grammarAccess.getGridLayoutAccess().getAlternatives_2(), "rule__GridLayout__Alternatives_2");
					put(grammarAccess.getGridLayoutCellStyleAccess().getAlternatives(), "rule__GridLayoutCellStyle__Alternatives");
					put(grammarAccess.getSpanInfoAccess().getAlternatives(), "rule__SpanInfo__Alternatives");
					...
					put(grammarAccess.getHorizontalLayoutAccess().getGroup_2_0(), "rule__HorizontalLayout__Group_2_0__0");
					put(grammarAccess.getHorizontalLayoutAccess().getGroup_2_1(), "rule__HorizontalLayout__Group_2_1__0");
					put(grammarAccess.getHorizontalLayoutCellStyleAccess().getGroup_0(), "rule__HorizontalLayoutCellStyle__Group_0__0");
					put(grammarAccess.getHorizontalLayoutCellStyleAccess().getGroup_1(), "rule__HorizontalLayoutCellStyle__Group_1__0");
					put(grammarAccess.getVerticalLayoutAccess().getGroup(), "rule__VerticalLayout__Group__0");
					put(grammarAccess.getVerticalLayoutAccess().getGroup_2_0(), "rule__VerticalLayout__Group_2_0__0");
					put(grammarAccess.getVerticalLayoutAccess().getGroup_2_1(), "rule__VerticalLayout__Group_2_1__0");
					put(grammarAccess.getVerticalLayoutCellStyleAccess().getGroup_0(), "rule__VerticalLayoutCellStyle__Group_0__0");
					put(grammarAccess.getVerticalLayoutCellStyleAccess().getGroup_1(), "rule__VerticalLayoutCellStyle__Group_1__0");
					put(grammarAccess.getGridLayoutAccess().getGroup(), "rule__GridLayout__Group__0");
					put(grammarAccess.getGridLayoutAccess().getGroup_2_0(), "rule__GridLayout__Group_2_0__0");
					put(grammarAccess.getGridLayoutAccess().getGroup_2_1(), "rule__GridLayout__Group_2_1__0");
					put(grammarAccess.getGridLayoutAccess().getGroup_2_3(), "rule__GridLayout__Group_2_3__0");
					put(grammarAccess.getGridLayoutCellStyleAccess().getGroup_0(), "rule__GridLayoutCellStyle__Group_0__0");
					put(grammarAccess.getGridLayoutCellStyleAccess().getGroup_1(), "rule__GridLayoutCellStyle__Group_1__0");
					put(grammarAccess.getGridLayoutCellStyleAccess().getGroup_2(), "rule__GridLayoutCellStyle__Group_2__0");
					put(grammarAccess.getSpanInfoAccess().getGroup_0(), "rule__SpanInfo__Group_0__0");
					put(grammarAccess.getSpanInfoAccess().getGroup_0_0(), "rule__SpanInfo__Group_0_0__0");
					put(grammarAccess.getSpanInfoAccess().getGroup_0_1(), "rule__SpanInfo__Group_0_1__0");
					put(grammarAccess.getSpanInfoAccess().getGroup_1(), "rule__SpanInfo__Group_1__0");
					...
					put(grammarAccess.getActionAccess().getBodyAssignment_2_1(), "rule__Action__BodyAssignment_2_1");
					put(grammarAccess.getHorizontalLayoutAccess().getIdAssignment_1(), "rule__HorizontalLayout__IdAssignment_1");
					put(grammarAccess.getHorizontalLayoutAccess().getCellStylesAssignment_2_0_1(), "rule__HorizontalLayout__CellStylesAssignment_2_0_1");
					put(grammarAccess.getHorizontalLayoutAccess().getFillHorizontalAssignment_2_1_0(), "rule__HorizontalLayout__FillHorizontalAssignment_2_1_0");
					put(grammarAccess.getHorizontalLayoutCellStyleAccess().getTargetAssignment_0_1(), "rule__HorizontalLayoutCellStyle__TargetAssignment_0_1");
					put(grammarAccess.getHorizontalLayoutCellStyleAccess().getAlignmentAssignment_1_1(), "rule__HorizontalLayoutCellStyle__AlignmentAssignment_1_1");
					put(grammarAccess.getVerticalLayoutAccess().getIdAssignment_1(), "rule__VerticalLayout__IdAssignment_1");
					put(grammarAccess.getVerticalLayoutAccess().getCellStylesAssignment_2_0_1(), "rule__VerticalLayout__CellStylesAssignment_2_0_1");
					put(grammarAccess.getVerticalLayoutAccess().getFillVerticalAssignment_2_1_0(), "rule__VerticalLayout__FillVerticalAssignment_2_1_0");
					put(grammarAccess.getVerticalLayoutCellStyleAccess().getTargetAssignment_0_1(), "rule__VerticalLayoutCellStyle__TargetAssignment_0_1");
					put(grammarAccess.getVerticalLayoutCellStyleAccess().getAlignmentAssignment_1_1(), "rule__VerticalLayoutCellStyle__AlignmentAssignment_1_1");
					put(grammarAccess.getGridLayoutAccess().getIdAssignment_1(), "rule__GridLayout__IdAssignment_1");
					put(grammarAccess.getGridLayoutAccess().getCellStylesAssignment_2_0_1(), "rule__GridLayout__CellStylesAssignment_2_0_1");
					...
					put(grammarAccess.getSpanInfoAccess().getColumnFromAssignment_0_0_1(), "rule__SpanInfo__ColumnFromAssignment_0_0_1");
