		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUiIDEViewAccess().getBindingEndpointAliasAssignment_6(), "rule__UiIDEView__BindingEndpointAliasAssignment_6");
					put(grammarAccess.getUiIDEViewAccess().getBindingsAssignment_7(), "rule__UiIDEView__BindingsAssignment_7");
					put(grammarAccess.getUiIDEViewAccess().getValidatorAssignmentsAssignment_8(), "rule__UiIDEView__ValidatorAssignmentsAssignment_8");
					...
					put(grammarAccess.getUiMobileViewAccess().getBindingEndpointAliasAssignment_6(), "rule__UiMobileView__BindingEndpointAliasAssignment_6");
					put(grammarAccess.getUiMobileViewAccess().getBindingsAssignment_7(), "rule__UiMobileView__BindingsAssignment_7");
					put(grammarAccess.getUiMobileViewAccess().getValidatorAssignmentsAssignment_8(), "rule__UiMobileView__ValidatorAssignmentsAssignment_8");
